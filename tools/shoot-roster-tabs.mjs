// Lobby → Inventory/Team → screenshot the Chains and Items tabs (3-slot loadout UI).
...
await page.mouse.click(230, 215); await sleep(2500);          // Inventory/Team station (left col idx 0)
await shot("rt-00-monsters");
await page.mouse.click(169, 28); await sleep(1200);           // Chains tab (rect 127-211)
