...
export const DEFAULT_AI_CONFIG = {
  ...
  // visual BUILDER composes the creature FROM SCRATCH as free-form HTML/CSS markup (src/systems/
  // htmlModel.js). A small model authors the visual unreliably (blank/sparse monsters), so the Builder
