...
export const CHARACTER_SKINS = [
  { id: "azure",   name: "Azure Tamer",    rarity: "Common",    model: "cloak", accent: [70, 166, 255],  cloak: [24, 21, 34], acquire: { kind: "cost", cur: "gold", amount: 150 } }, // TQ-134: only the default (Ember Warden) is free
  { id: "ember",   name: "Ember Warden",   rarity: "Common",    model: "cloak", accent: [255, 132, 80],  cloak: [34, 20, 18], acquire: { kind: "free" } },
  { id: "verdant", name: "Verdant Walker", rarity: "Uncommon",  model: "cloak", accent: [96, 214, 134],  cloak: [18, 30, 22], acquire: { kind: "cost", cur: "gold", amount: 200 } },
  ...
  { id: "vanguard",   name: "Iron Vanguard",      rarity: "Uncommon",  model: "knight",    accent: [200, 212, 230], cloak: [40, 44, 54], acquire: { kind: "cost", cur: "gold", amount: 200 } },
  { id: "warden",     name: "Wild Warden",        rarity: "Uncommon",  model: "warden",    accent: [214, 150, 92],  cloak: [34, 26, 20], acquire: { kind: "cost", cur: "gold", amount: 200 } },
  ...
  { id: "ronin",      name: "Wandering Ronin",    rarity: "Uncommon",  model: "ronin",     accent: [235, 110, 96],  cloak: [30, 28, 32], acquire: { kind: "cost", cur: "gold", amount: 200 } },
  ...
  { id: "myconid",    name: "Sporeling Myconid",  rarity: "Uncommon",  model: "myconid",   accent: [186, 140, 255], cloak: [34, 28, 32], acquire: { kind: "cost", cur: "gold", amount: 200 } },
  ...
  { id: "pumpkin",    name: "Jack-o'-Lantern",    rarity: "Uncommon",  model: "pumpkin",   accent: [255, 160, 60],  cloak: [40, 28, 18], acquire: { kind: "cost", cur: "gold", amount: 200 } },
  ...
  // TQ-67/TQ-132: a premium cosmetic — visual-only, bought with essence (the paid currency). A cloak
  // recolour (no new model art); price is a tunable starter offering for monetization (00005) to curate.
  { id: "sovereign",  name: "Obsidian Sovereign", rarity: "Legendary", model: "cloak",     accent: [180, 140, 255], cloak: [20, 18, 30], acquire: { kind: "cost", cur: "essence", amount: 150 } },
];
