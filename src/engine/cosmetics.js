...
// A skin is priced in gold (earned) or essence (premium/paid); both balances are
// server-authoritative, so the server runs this same math against the stored profile.
