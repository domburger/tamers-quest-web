...
// creatures from scratch as free-form SVG markup (svgModel.js), so the old archetype-description
// / feature-overlay vocabulary (and its canonicalFeature/renderEnvironmentBrief helpers) was
// removed along with the tests that guarded it. BODY_SHAPES is still the procedural renderer's
// fallback silhouette set for the model-less offline seed bundle, so it's the one thing left to pin down.
