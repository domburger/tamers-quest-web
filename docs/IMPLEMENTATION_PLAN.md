...
>
> **Phases:**
- [x] **WIN-T1 — Square-window geometry + frame (foundation).** ✅ `src/render/playWindow.js`
      ...
      ✅ **Peripheral dim enabled 2026-06-08 (`@visual`):** dropped the `dim: 0` override in both
      SP `game.js` (7c6d941) and MP `onlineGame.js` (699ba87) — `drawPlayWindow` now uses its
      default 0.28 opacity vignette. Safe after WIN-T2 landed (HUD anchors to the square, not canvas).
      **WIN-T1 complete.**
